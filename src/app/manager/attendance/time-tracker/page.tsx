  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-semibold text-slate-900 dark:text-zinc-100">Time tracker</h1>
      ...
      <div className="flex flex-wrap items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm shadow-sm">
        ...
        <span className="font-medium tabular-nums text-slate-800 dark:text-zinc-200">{isoKey}</span>
        <Link
