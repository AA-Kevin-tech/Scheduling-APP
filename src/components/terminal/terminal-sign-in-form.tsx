    ...
    <form ref={formRef} action={action} className="mx-auto max-w-md space-y-5">
      <div>
        ...
        <input
          ...
          required
          className="mt-2 w-full rounded-lg border border-slate-300 px-4 py-3 text-lg text-slate-900 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-200"
        />
      </div>
      <div>
        <label
